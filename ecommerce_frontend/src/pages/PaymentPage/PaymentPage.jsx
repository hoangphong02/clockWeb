...
console.log("state",stateUserDetails)
  ...
  useEffect(()=>{
   ...
   const mutationAddOrder = useMutationHook(
    ...
    const { data: dataAdd, isLoading: isLoading, isSuccess: isSuccsess, isError: isError } = mutationAddOrder
    ...
    return ( 
        ...
        <div style={{display:"flex"}} >
            ...
            <div style={{background:"#fff", padding:"20px"}}>
              <span style={{fontSize:"20px"}}>Chọn hình thức giao hàng</span>
              ...
              <Radio.Group onChange={onChangeRadioDelevery} defaultValue={"Fast Giao hàng tiết kiệm"}  >
                <Space direction="vertical">
                  <Radio value={"Fast Giao hàng tiết kiệm"}><span style={{color:"coral", fontWeight:"500"}}>Fast</span> <span>Giao hàng tiết kiệm</span></Radio>
            ...
            <div style={{background:"#fff", padding:"20px",margin:"10px 0"}}>
              <span style={{fontSize:"20px"}}>Chọn hình thức thanh toán</span>
              <div style={{background: "rgb(240, 248, 255)",border: "1px solid rgb(194, 225, 255)",width: "500px",padding: "15px",borderRadius: "20px",margin:"10px 0"}}>
              <Radio.Group onChange={onChangeRadioPayment} value={payment} >
      <Space direction="vertical">
        <Radio value={"Thanh toán khi nhận hàng"}><img style={{width:"20px"}} src={imagePay}/> <span>Thanh toán khi nhận hàng</span></Radio>
        <Radio value={"Thanh toán bằng ví MoMo"}><span style={{display:"flex"}}><img style={{width:"20px"}} src={imageMoMo}/> <span >Thanh toán bằng ví MoMo</span></span></Radio>
        <Radio value={"Thanh toán bằng ví Paypal"}><span style={{display:"flex"}}><img style={{width:"20px"}} src={imagePayment}/> <span >Thanh toán bằng ví Paypal</span></span></Radio>
      </Space>
    </Radio.Group>
            ...
            <div style={{textAlign:"center", padding:"20px"}} >
              {payment === "Thanh toán bằng ví Paypal" && sdkReady ? (<PayPalButton
      ...
      />):( <ButtonComponent textButton={"Đặt hàng"} style={{background:"red", color:"#fff",height:"50px", width:"200px", fontWeight:"700"}} onClick={()=>handleAddOrder()}/>)}
