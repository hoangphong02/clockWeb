...
const CartSliderComponent = (props) => {
  ...
  >
   <StyleNameProduct style={{overflow:"hidden",height:"32.5px"}}>{name}</StyleNameProduct>
   <WrapperReportText>
    <span>
    <span>{rating}</span>
    ...
    <WrapperPriceText style={{ backgroundImage:`url(${imagebg})`}}><span style={{marginRight: "8px"}}>{price.toLocaleString()} vnd </span><WrapperDiscountText> - {discount}%</WrapperDiscountText></WrapperPriceText>
