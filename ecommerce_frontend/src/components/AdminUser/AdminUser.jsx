...
const AdminUser = () => {
 ...
 const { data: dataDeletedMany, isLoading: isLoadingDeletedMany, isSuccess: isSuccessDelectedMany, isError: isErrorDeletedMany } = mutationDeletedMany
  ...
  >
    ...
    >
      <InputComponent value = {stateUserDetails._id} onChange ={handleOnchangeDetails} name="_id"/>
    </Form.Item>
    <Form.Item
      label="Name"
      name="name"
    ...
    >
      <InputComponent value = {stateUserDetails.createdAt} onChange ={handleOnchangeDetails} name="createdAt"/>
    </Form.Item>
    ...
    >
      <InputComponent value = {stateUserDetails.updatedAt} onChange ={handleOnchangeDetails} name="UpdatedAt"/>
    </Form.Item>
