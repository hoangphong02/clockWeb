...
const CreateNewPassword = () => {
  ...
  const mutation = useMutationHook((data) => OtpService.createOtp(data));
  ...
  const mutationDeleteOtp = useMutationHook((data) =>
    OtpService.deleteOtp(data)
  );
  const onDeleteOtp = () => {
