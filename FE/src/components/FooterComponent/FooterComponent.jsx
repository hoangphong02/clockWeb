          ...
          <div className="row">
            ...
            <div className="col-md pr-md-5 mb-4 mb-md-0">
              ...
              <ul className="list-unstyled quick-info mb-4">
                ...
                <li><a href="#" className="d-flex align-items-center"><span className="icon mr-3 icon-envelope"></span> Khu II, Đ. 3 Tháng 2, Xuân Khánh, Ninh Kiều, Cần Thơ </a></li>
  ...
  <input type="submit" className="btn btn-submit" value="Send" />
            ...
            <div className="col-md mb-4 mb-md-0" >
              ...
              <ul className="list-unstyled tweets" >
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.8415184420583!2d105.76804037479394!3d10.029933690077012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0895a51d60719%3A0x9d76b0035f6d53d0!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBD4bqnbiBUaMah!5e0!3m2!1svi!2s!4v1712733761743!5m2!1svi!2s" style={{width:"80%" ,height:"19em", border: "0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"/>
              </ul>
            </div>
